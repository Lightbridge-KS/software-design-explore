                  ...
                  items: [
                      ...
                      },
                      {
                          ...
                          items: [
                              ...
                              { label: 'FLIP (Architecture)', slug: 'case-studies/systems/flip' },
                              { label: 'FLIP (Data Model)', slug: 'case-studies/systems/flip_data_architecture' },
                              { label: 'FLIP (OMOP DB)', slug: 'case-studies/systems/flip-omop-db' },
                              { label: 'FLIP (Client Node Integration)', slug: 'case-studies/systems/flip_client_node_integration' },
                              { label: 'Gitcrawl (Architecture)', slug: 'case-studies/systems/gitcrawl_system_oop_architecture' },
                              { label: 'Gitcrawl (Data Model)', slug: 'case-studies/systems/gitcrawl_data_architecture' },
                              { label: 'Gitcrawl (Agentic Design)', slug: 'case-studies/systems/gitcrawl_agentic_architecture' },
